...
%% Transient - 3
%%% Runs a simulation of cold-slug instertion through dysfunctional DHRS
...
%%% Step - 2; Using DHRS_MODE = 2, Dysfunctional DHRS open at 2000[s]
%%% Step - 3; Dysfunctional DHR drops, DHRS node temp by 30C for 8.46[s]
%%% Step - 4; Simulation continued till 2200[s]

%% User Inputs

%%% Basic Simulation Parameters
simtime = 2200;                                                            %Simulation time [s]
ts_max = 1e-2;                                                             %Maximum timestep [s] 
P=100;                                                                       %Operational thermal power [MW]
...
hold on
grid on
plot(time,DHRS_outlet_temp,'color','#9dfc03','LineWidth',1)
...
title('Primary Loop Temperatures')
legend('DHRS Outlet','Core Inlet','Core Graphite', 'Core Outlet')
...
saveas(gcf,'Transient_3.png')
savefig('Transient_3.fig')
